...
-- Tiempo de generación: 05-12-2018 a las 21:23:50
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  PRIMARY KEY (`idpedidos`,`clientes_idclientes`,`estados_idestados`,`formadepago_idformadepago`) USING BTREE,
  KEY `fk_pedidos_clientes1_idx` (`clientes_idclientes`),
  KEY `fk_pedidos_estados1_idx` (`estados_idestados`),
  KEY `fk_pedidos_formadepago_idx` (`formadepago_idformadepago`) USING BTREE
...
INSERT INTO `pedidos` (`idpedidos`, `clientes_idclientes`, `fecha_pedido`, `total_pedido`, `estados_idestados`, `formadepago_idformadepago`) VALUES
(1, 1, '2018-12-02 19:11:36', 15.000, 1, 2),
(2, 1, '2018-12-02 20:15:54', 25.000, 1, 1),
(3, 1, '2018-12-02 21:29:35', 15.000, 1, 0),
(4, 2, '2018-12-02 22:01:34', 100.000, 1, 0),
(5, 1, '2018-12-02 22:06:19', 10.000, 1, 0),
(6, 1, '2018-12-02 22:54:06', 15.000, 1, 0),
(7, 1, '2018-12-03 20:21:46', 100.000, 1, 0),
(8, 1, '2018-12-03 20:23:14', 150.000, 1, 0),
(9, 1, '2018-12-03 20:24:08', 150.000, 1, 0),
(10, 1, '2018-12-03 21:32:12', 55.000, 1, 0),
(11, 1, '2018-12-03 21:33:12', 8.000, 1, 0);
...
(1, 'andres ', 'chavez', '10', 'calle 20', 'afchavez99@misena.edu.co', 1023959599, '7395', 1, 1, 1, 1),
(2, 'Hector', 'Vallejo', '3514789', 'cll 10 sur mini mordor', 'germangal1996@gmail.com', 1000, '1200', 1, 1, 1, 1),
(3, 'El Admin', 'cabezas', '319', 'calle', 'dlcabezas2@gmail.com', 123, 'YSxrDMWN', 1, 1, 1, 1),
(4, 'Angie ', 'Palacios ', '3202023354', 'calle 6', 'angie.stefania10@gmail.com', 1000802537, 'V1l8CucK', 2, 1, 1, 1),
(5, 'david', 'diaz', '719565', 'dsadsadsa', 'davidesteban.1319@gmail.com', 789, '987', 1, 2, 1, 2),
...
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `FK_id_formadepago` FOREIGN KEY (`formadepago_idformadepago`) REFERENCES `formadepago` (`idformadepago`),
